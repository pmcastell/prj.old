...
/*** Asigna un árbol al actual los hijos quedan compartidos          **********/
/*** Parámetros: a-> árbol a asignar                                 **********/
/*** Deuelve: nada                                                   **********/
...
/*** Realiza una copia completa del árbol pasado como parámetro      **********/
/*** Parámetros: a-> árbol a copiar                                  **********/
/*** Deuelve: un nuevo árbol totalmente igual que el original        **********/
...
/*** Realiza una copia de éste árbol                                 **********/
/*** Parámetros: ninguno                                             **********/
/*** Deuelve: una copia totalmente idéntica del árbol actual         **********/
    public arbol_binario copia()
    {
        return copia(this);
    }

/*** Nos dice si éste árbol es totalmente igual a otro               **********/
/*** Parámetros: b-> árbol con el que se compara                     **********/
...
/*** Nos dice si dos árboles son totalmente idénticos                **********/
/*** Parámetros: a,b-> árboles a comparar                            **********/
...
/*** Asigna a éste árbol su hijo izquierda                           **********/
/*** Parámetros: ninguno                                             **********/
/*** Deuelve: nada                                                   **********/
...
/*** Asigna a éste árbol su hijo derecha                             **********/
/*** Parámetros: ninguno                                             **********/
/*** Deuelve: nada                                                   **********/
