...
public final class ctes_eval {
   ...
   public  static final int INTEGRAL      =298;


   public  static final int FOR           =299;
   public  static final int IF            =300;
   public  static final int ELSE          =301;
   public  static final int ELSEIF         =302;
   public  static final int WHILE         =303;
   public  static final int ACUMULADOR    =304; //registro último valor calculado
   public  static final int CTE           =305;
   public  static final int PTR           =306;
   public  static final int EXEC          =307;
   public  static final int PARAMETERS    =308;
   public  static final int INC           =309;
   public  static final int DEC           =310;
   public  static final int SUBSTR        =311;
   public  static final int TOUPPER       =312;
   public  static final int TOLOWER       =313;
   public  static final int TYPE          =314;
   public  static final int DERIV         =315;
   public  static final int LEN           =316;
   public  static final int INT           =317;
   public  static final int DIMENS        =318;
   public  static final int NDIM          =319;
   public  static final int RETURN        =320;
   public  static final int LEER          =321;
   private static final int ULTIMO        =321; // con esto controlamos que un token sea válido
   ...
   public static String nombres[]={"acos","asen","atan","ceil","cos",
      ...
      "e","IDENTIFICADOR","LITERAL_CADENA","EOF","","dim","true","false","integral",
      "for","if","else","elseif","while","?","CTE","ptr","exec","parameters",
      "inc","dec","substr","toupper","tolower","type","deriv","len","int",
