...
import controls.TwoState3DButton;
...
public class Orbits extends P2Applet
{
    ...
    public void init()
    {
        ...
        button = new TwoState3DButton("Ver Fuerza", i1, "No- Fuerza", i2);
    ...
    public boolean action(Event e, Object arg)
    {
        if(e.target == button)
        {
            forceOn = ((TwoState3DButton)e.target).getValue();
    ...
    private TwoState3DButton button;
