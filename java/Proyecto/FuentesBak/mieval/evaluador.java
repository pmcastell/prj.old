...
/*** Parámetros: t -> carácter recíén leído                          **********/
...
/*** Parámetros: t-> carácter recién leído de la entrada             **********/
...
/******************************************************************************/
/******************************************************************************/
/**************** Analizador Sintáctico e itérprete ***************************/
/******************************************************************************/
/******************************************************************************/
...
/*** Evaluación de expresiones en la cadena de entrada               **********/
/*** Parámetros: ninguno                                             **********/
/*** Devuelve: el valor resultado de evaluar la expresión           **********/
...
/*** Devuelve: el valor resultado de evaluar la expresión            **********/
    variable expr() throws SyntaxErrorException
    {
       ...
       if (lexema_actual.comp_lex==ctes_eval.ID) {
          r=asignacion(); // una asignación es una expresión
          if (r!=null) {
             return r;
          }
       }
...
/*** Asignación y Evaluación de expresiones en la cadena de entrada  **********/
/*** Parámetros: ninguno                                             **********/
...
/*** Devuelve: el valor resultado de evaluar la expresión            **********/
    variable potencia() throws SyntaxErrorException
    {
       ...
       switch(lexema_actual.comp_lex) {
          ...
          //funciones con 1º parámetro tipo matriz
...
/*** Retira y evalúa la función condicional de la cadena de entrada  **********/
/*** Parámetros: ninguno                                             **********/
...
/*** Ejecuta una función o programa contenido en un fichero          **********/
...
/*** Devuelve: el valor calculado en último lugar en la ejecución    **********/
    variable exec(String fichProg,Vector parametros) throws SyntaxErrorException
    {
        ...
        if (r.tipo!='E') {
           String s;
          //mostramos nuevos valores parámetros de salida en listaVariables
           for(int i=0;i<listaParamSalida.size(); i++) {
...
/*** Devuelve: el valor resultado de evaluar la expresión            **********/
    variable valID() throws SyntaxErrorException
    {
       ...
       lexem_aux=lexema_actual;
       match(ctes_eval.ID);
       if (lexema_actual.comp_lex=='(') { // llamada a función o programa
...
/******************************************************************************/
/********** Cáulo Simbólico: **************************************************/
/********** Evaluación de la derivada de una Expresión en la entrada **********/
/******************************************************************************/
/******************************************************************************/
...
/***     alguna regla de simplificación y en caso afirmativo aplica  **********/
/***     dicha regla al árbol sintático                              **********/
/*** Parámetros: e-> expresión a simplificar                         **********/
/*** Devuelve: nada                                                  **********/
...
/***                 transformación caso que encaje en p             **********/
/*** Devuelve: true si se aplicó transformación false en caso        **********/
/***     contrario                                                   **********/
...
/***                  que ocupen la misma posición sobre la lista    **********/
/***                  vpr                                            **********/
/***             vpr->lista de patrones que sustituirán a los que    **********/
/***                  ocupen la misma posición sobre la lista vp     **********/
/*** Devuelve: nada                                                  **********/
...
/*** Devuelve: la posición del árbol dentro de la lista              **********/
...
/***     entre los patrones que ocupan la misma posición en ambas    **********/
/***     listas                                                      **********/
...
/*** Llamada por la instrucción de lectura del lenguaje para leer    **********/
    ...
    void leerVariable(String mensa, variable v) throws SyntaxErrorException
    {
       ...
       while (true) {
          ...
          try {
             ...
             cuadro_mensaje("Error la expresión introducida debe ser de tipo "+
...
/******************************************************************************/
/******************************************************************************/
/************     funciones de comunicación con otros objetos   ***************/
/******************************************************************************/
/******************************************************************************/

/*** Añade un objeto a la lista de elementos que serán notificados   **********/
/***     de algún evento, como p.ej. la creación de una variable     **********/
...
/***     instántane a la ejecución de programas y/o comandos         **********/
...
/*** 'Evento' de notificación a la lista de notificados de la        **********/
...
/*** Devuelve: nada                                                  **********/
    void notifiNuevaVariable(variable ve)
    {
       ...
       if (vb!=null) {
          if (notificacion) { // esto enlentece mucho la ejecución
...
/*** 'Evento' de notificación de que se ha pasado a un nuevo entorno **********/
/***     o ámbito de ejecución, p.ej. cuando se llama a una función  **********/
...
/*** 'Evento' de notificación de que se ha salido del último entorno **********/
...
/*** Parámetros: i-> posición del elemento a devolver                **********/
...
/*** Salva el entorno de ejecución actualmente en curso              **********/
/*** Parámetros: ninguno                                             **********/
/*** Devuelve: nada                                                  **********/
    void salva_entorno()
    {
...
/*** Restaura último entorno de ejecución salvado                    **********/
/*** Parámetros: ninguno                                             **********/
/*** Devuelve: nada                                                  **********/
...
/*** Devuelve la posición de una cadena dentro de otra ignorando     **********/
/***     mayúsculas                                                  **********/
/*** Parámetros: s1-> cadena dentro de la que se mira                **********/
/***             s2-> cadena que se busca dentro de s1               **********/
/*** Devuelve: un entero >=0 que representa la posición a partir de  **********/
...
/*** Inserta un espacio entre el nombre de una función y su argumento**********/
