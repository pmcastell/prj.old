    ...
    implements Runnable
{
    ...
    private void getMapImage(double d, double d1, boolean flag)
    {
        ...
        try
        {
            ...
            URL url = new URL("http","visualroute.visualware.com",80,"");//m_applet.getCodeBase();
            ...
            m_image = Toolkit.getDefaultToolkit().getImage(url2);
    ...
    public void run()
    {
        ...
        try
        {
            String s1 =null;// m_applet.getLang();
            long l = System.currentTimeMillis() / 1000L;
            String s2 = "visualroute.visualware.com";//m_applet.getDocumentBase().getHost();
            String s3 = "";
            String s4 = null;
    ...
    public boolean mouseMove(Event event, int i, int j)
    {
        ...
        //m_applet.showStatus("hola Mundo!!");
        return true;
    }
    ...
    public VisualRoutePanel(VisualRouteApplet visualrouteapplet, VisualRoutePanel visualroutepanel)
    {
        ...
        String s = "http://visualroute.visualware.com/"; //m_applet.getParameter("url");
