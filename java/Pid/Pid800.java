...
public class Pid800 extends Applet {
...
//Component initialization
  ...
  this.setSize(new Dimension(760, 530));
  label1.setFont(new Font("Dialog", 1, 16));
  label1.setBounds(new Rectangle(38, 2, 703, 28));
  label1.setText("P.I.D. - Conversión Matriz Binaria-Arbol Cuadrados y Etiquetada de " +
    "Componentes Conexas");
  matrizOriginal.setFont(new Font("Monospaced", 1, 22));
  matrizOriginal.setBounds(new Rectangle(4, 29, 350, 436));
  matrizConexa.setFont(new Font("Monospaced", 1, 22));
  matrizConexa.setBounds(new Rectangle(357, 29, 396, 436));
  button1.setBounds(new Rectangle(563, 498, 187, 26));
  button1.setLabel("Buscar Componentes Conexas");
  Button button2 = new Button();
  button2.setBounds(new Rectangle(457, 498, 99, 26));
  button2.setLabel("Cargar Fichero");
  button3.setBounds(new Rectangle(4, 467, 84, 18));
  ...
  button4.setBounds(new Rectangle(666, 467, 84, 18));
  ...
  negro.setBounds(new Rectangle(4, 486, 57, 18));
  negro.setState(true);
  ...
  blanco.setBounds(new Rectangle(3, 509, 58, 18));
  blanco.setLabel("Blanco");
  negroAdy_4.setBounds(new Rectangle(63, 485, 95, 19));
  ...
  blancoAdy_8.setBounds(new Rectangle(159, 509, 101, 18));
  ...
  blancoAdy_4.setBounds(new Rectangle(63, 509, 95, 19));
  negroAdy_8.setBounds(new Rectangle(159, 485, 101, 18));
