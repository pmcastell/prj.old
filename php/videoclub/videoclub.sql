...
USE videoclub;
GRANT ALL PRIVILEGES ON videoclub.* TO videoclub@localhost IDENTIFIED BY 'videoclub2008';
...
INSERT INTO `socios` VALUES ('11111111H', 'Francisco', 'Pérez', NULL, '954001122', 'C/ Flor de Romero, 25, 3-A.', '41020', 'Sevilla', 10.00, 'francisco2011');
INSERT INTO `socios` VALUES ('12345678Z', 'admin', 'Criado', 'Navarro', '954073065', 'C/ Flor de Tomillo, 4, 7º B.', '41020', 'Sevilla', 26.25, 'admin2011');
INSERT INTO `socios` VALUES ('22222222', 'Pedro', 'Pica', 'Piedra', '954332211', 'C/ Los alamos', '41020', 'Sevilla', 33.25, 'pedro2011');
INSERT INTO `socios` VALUES ('25126190R', 'Francisco', 'Alegre', 'Y Olé', '954001122', 'C/ Flor de Lis, 23, 2-A', '41020', 'Sevilla', 10.00, 'francisco2011');
INSERT INTO `socios` VALUES ('33333333P', 'p', 'p', NULL, '9', 'p', '41020', 'Sevilla', 10.00, 'p2011');
INSERT INTO `socios` VALUES ('87654321X', 'Emilia', 'Gutiérrez', 'López', '954332211', 'C/ Flor de Gitanilla, 5.', '41020', 'Sevilla', 33.25, 'emilia2011');
INSERT INTO `socios` VALUES ('87654326S', 'Fernando', 'García', NULL, '93442212', 'C/ Olivares, 32.', '08080', 'Barcelona', 23.25, 'fernando2011');
INSERT INTO `socios` VALUES ('88888888Y', 'Luisa', 'Gutiérrez', NULL, '91123456', 'C/ Flor de Gitanilla, 5.', '41020', 'Barcelona', 12.75, 'luisa2011');
INSERT INTO `socios` VALUES ('99999999R', 'Pepito', 'Grillo', 'Saltamontes', '954302030', 'C/ Flor de Esgueva, 6.', '41020', 'Sevilla', 20.25, 'pepito2011');



INSERT INTO `ingresos` VALUES (1, '12345678Z', '2011-01-01', 5.25);
INSERT INTO `ingresos` VALUES (2, '12345678Z', '2011-02-02', 5.25);
INSERT INTO `ingresos` VALUES (3, '12345678Z', '2011-03-03', 5.25);
INSERT INTO `ingresos` VALUES (4, '12345678Z', '2011-04-04', 5.25);
INSERT INTO `ingresos` VALUES (5, '12345678Z', '2011-05-05', 5.25);
INSERT INTO `ingresos` VALUES (6, '99999999R', '2011-01-01', 5.25);
INSERT INTO `ingresos` VALUES (7, '99999999R', '2011-02-02', 5.75);
INSERT INTO `ingresos` VALUES (8, '99999999R', '2011-03-03', 5.25);
INSERT INTO `ingresos` VALUES (9, '99999999R', '2011-04-04', 3.25);
INSERT INTO `ingresos` VALUES (10, '99999999R', '2011-05-05', 0.75);
INSERT INTO `ingresos` VALUES (11, '25126190R', '2011-05-27', 10.00);
INSERT INTO `ingresos` VALUES (12, '33333333P', '2011-05-27', 5.00);
INSERT INTO `ingresos` VALUES (13, '22222222', '2011-06-05', 10.00);

                              

INSERT INTO `tarifas` VALUES (1, '2006-01-01', 0.80, 1.10, 1.30, 1.50);
INSERT INTO `tarifas` VALUES (2, '2011-01-01', 0.90, 1.20, 1.50, 1.75);
...
INSERT INTO `peliculas` VALUES ( 9,'El último rey de esocia', 'Drama, Acción', '2011-02-23', 'Kevin Macdonald', 'Forest Whitaker,  James McAvoy, Kerry Washington', 'In the early 1970s, Nicholas Garrigan, a young semi-idealistic Scottish doctor, comes to Uganda to assist in a rural hospital. Once there, he soon meets up with the new President, Idi Amin, who promises a golden age for the African nation. Garrigan hits it off immediately with the rabid Scotland fan, who soon offers him a senior position in the national health department and becomes one of Amin''s closest advisers. However as the years pass, Garrigan cannot help but notice Amin''s increasingly erratic ', 'elUltimoReyDeEscocia.jpg');
...
INSERT INTO `alquileres` VALUES (1, '25126190R', '2011-06-05 19:51:00', 1);

INSERT INTO `detalle_alquileres` VALUES (1,1,12, NULL, NULL);

INSERT INTO `alquileres` VALUES (2, '12345678Z', '2011-04-08 12:15:00', 2);

INSERT INTO `detalle_alquileres` VALUES (2,2, 1, '2011-04-08 15:15:00', NULL);
INSERT INTO `detalle_alquileres` VALUES (3,2, 2, '2011-04-08 18:13:00', NULL);
INSERT INTO `detalle_alquileres` VALUES (4,2, 3, '2011-04-09 00:13:00', NULL);
INSERT INTO `detalle_alquileres` VALUES (5,2, 4, '2011-04-09 18:18:00', NULL);


INSERT INTO `alquileres` VALUES (3, '99999999R', '2011-04-18 16:16:00', 2);
INSERT INTO `detalle_alquileres` VALUES (6,3, 4, NULL, NULL);
INSERT INTO `detalle_alquileres` VALUES (7,3, 5, NULL, NULL);

INSERT INTO `alquileres` VALUES (4, '87654321X', '2011-05-20 22:56:00', 2);
INSERT INTO `detalle_alquileres` VALUES (8,4, 7, '2011-05-20 23:29:00', NULL);

INSERT INTO `alquileres` VALUES (5, '87654321X', '2011-05-20 23:07:00', 1);
INSERT INTO `detalle_alquileres` VALUES (9,5, 10, NULL, NULL);

INSERT INTO `alquileres` VALUES (6, '22222222', '2011-06-05 19:38:00', 1);
INSERT INTO `detalle_alquileres` VALUES (10,6, 15, NULL, NULL);


INSERT INTO `alquileres` VALUES (7, '25126190R', '2011-06-06 20:10:00', 1);
