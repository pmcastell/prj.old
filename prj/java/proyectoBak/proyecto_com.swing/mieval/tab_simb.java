...
/******************************************************************************/
/******************************************************************************/
/*** Esta es utilizada por la clase tab_simb (tabla de símbolos) como   *******/
/*** 'registros' enlazados de la tabla de símbolos (lista enlazada)        ****/
/******************************************************************************/
/******************************************************************************/
class mientrada {
    entrada simb;
...
/*** Busca una entrada en la tabla de símbolos                       **********/
/*** Parámetros: v-> variable contenida en la entrada a buscar       **********/
/*** Devuelve: una referencia a la entrada si se encuentra, null en  **********/
/***     caso contrario                                              **********/
...
/*** Busca una entrada en la tabla de símbolos                       **********/
/*** Parámetros: s-> nombre de la variable contenida en entrada a buscar*******/
/*** Devuelve: una referencia a la entrada si se encuentra, null en  **********/
/***     caso contrario                                              **********/
...
/*** Insxerta una nueva entrada en la tabla de símbolos              **********/
/*** Parámetros: comp_lex-> entero que representa al token           **********/
...
/***     caso contrario                                              **********/
   public entrada inserta(int comp_lex,variable valor)
   {
      if (valor.nombre==null) {
         System.out.println("Símbolo de longitud cero no permitido");
      }
      if (IgnoreCase) {
...
/***     doble en la tabla de símbolos                               **********/
/*** Parámetros: s-> nombre de la variable                           **********/
/***             comp_lex-> token asociado (p.ej. ID para una variable ********/
/***             valor-> valor doble que se asignará a la variable     ********/
/*** Devuelve: una referencia a la entrada si se encuentra, null en  **********/
/***     caso contrario                                              **********/
...
/*** Insxerta una nueva entrada en la tabla de símbolos              **********/
/*** Parámetros: e-> entrada a insertar                              **********/
/*** Devuelve: una referencia a la entrada si se encuentra, null en  **********/
/***     caso contrario                                              **********/
...
/*** Parámetros: s-> nombre de la variable cuya entrada hay que borrar*********/
/*** Devuelve: si la operación con éxito                             **********/
...
/*** Elimina una entrada de la tabla de símbolos                     **********/
/*** Parámetros: e-> entrada a eliminar                              **********/
/*** Devuelve: si la operación con éxito                             **********/
...
/*** Elimina una entrada de la tabla de símbolos                     **********/
/*** Parámetros: v-> variable contenida en la entrada a eliminar     **********/
/*** Devuelve: si la operación con éxito                             **********/
...
/*** Devuelve el número total de entradas de la tabla de símbolos    **********/
/*** Parámetros: ninguno                                             **********/
...
/***     i-ésima de la tabla o null si i 'está fuera de rango'       **********/
...
/*** Establece que en la comparación de cadenas no se distingua entre *********/
/***     mayúsculas y minúsculas, por defecto no se distingue.       **********/
/*** Parámetros: ninguno                                             **********/
/*** Devuelve: nada                                                  **********/
...
/*** Establece que en la comparación de cadenas  se distingua entre   *********/
/***     mayúsculas y minúsculas, por defecto no se distingue.       **********/
/*** Parámetros: ninguno                                             **********/
/*** Devuelve: nada                                                  **********/
...
/*** Parámetros: id-> nombre de la variable a asignar                **********/
...
/*** Asigna un nuevo valor numérico a una variable                   **********/
/*** Parámetros: id-> nombre de la variable a asignar                **********/
