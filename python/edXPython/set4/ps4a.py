...
def updateHand(hand, word):
    ...
    for letter in hand.keys():
        if (hand.get(letter,0)>word.count(letter)):
            res[letter]=hand.get(letter,0)-word.count(letter)
    return res
...
def isValidWord(word, hand, wordList):
    ...
    wordAux={}
    for l in word:
        wordAux[l]=wordAux.get(l,0)+1
    for l in wordAux.keys():
        if (hand.get(l,0)<wordAux[l]):
            return False
    return True
    ...
    while(calculateHandlen(hand)>0):
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                totalScore+=points
                print '"'+word+'" earned '+str(points)+' points. Total: '+str(totalScore)+' points '
                print
                # Update the hand 
