...
listaAccept() {
    ...
    ACCEPT="10.10.10.0/24 192.168.1.1 192.168.1.25 192.168.1.27 192.168.43.0/24 192.168.0.1 192.168.0.25 192.168.0.253 172.16.1.0/24 172.16.254.0/24 172.124.116.0/24 172.124.117.0/24 172.124.0.0/24 172.124.1.0/24 $ACCEPT $INSTI "
    echo "$ACCEPT"
}
main "$@"
exit 0
